...
public class TodoController {
    ...
    @PutMapping("/{id}")
    public ResultDTO<TodoDTO> modifyTodo(@PathVariable("id") Long id, @Valid @RequestBody TodoModifyDTO todoModifyDTO, BindingResult bindingResult) {

        return todoService.modify(id, todoModifyDTO);
    }
