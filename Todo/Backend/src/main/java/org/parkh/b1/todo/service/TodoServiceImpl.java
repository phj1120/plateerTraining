...
public class TodoServiceImpl implements TodoService {
    ...
    @Override
    public ResultDTO<TodoDTO> modify(Long id, TodoModifyDTO todoModifyDTO) {
        Todo todo = todoRepository.findById(id).orElseThrow(() -> {
            throw new RuntimeException();
        });

        String title = todoModifyDTO.getTitle();
        LocalDate dueDate = todoModifyDTO.getDueDate();
        Boolean complete = todoModifyDTO.getComplete();
        todo.modify(title, dueDate, complete);
